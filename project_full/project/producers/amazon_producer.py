...
titles = pd.read_csv('/home/hadoop/project/data/amazon-prime-tv-shows-and-movies/titles.csv')
credits = pd.read_csv('/home/hadoop/project/data/amazon-prime-tv-shows-and-movies/credits.csv')
titles['platform'] = 'Amazon'
titles['ingestion_timestamp'] = datetime.now().strftime("%Y-%m-%d %H:%M:%S")

credits['platform'] = 'Amazon'
...
producer.flush()
print("Amazon Titles & Credits sent to Kafka!")
